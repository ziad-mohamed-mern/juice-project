...
const products = [
  ...
  { id: 3, name: "عصير الفراولة", category: "توتيات", color: "from-red-400 to-red-600", price: "14 ر.س", nutrition: { calories: "32 kcal", vitaminC: "95%", sugar: "7g", fiber: "2g" }, desc: "عصير فراولة طازج يجمع بين الحلاوة والحموضة الخفيفة. غني بمضادات الأكسدة ومنعش للقلب.", img: "/images/strawberry_juice_alt.jpg" },
